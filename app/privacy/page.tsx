...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-navy-400 text-sm mb-10">Last updated: May 20, 2026</p>

      <div className="space-y-8 text-navy-200 text-sm leading-relaxed">
        <section>
          ...
          <p>
            ...
            <strong className="text-white">quicklytools.org</strong>. We are committed to protecting your
        ...
        <section>
          ...
          <p className="mb-3">
            <strong className="text-white">No personal data is collected by our tools.</strong> All
        ...
        <section>
          <h2 className="text-white font-semibold text-lg mb-3">Advertising</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold text-lg mb-3">Third-Party Links</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold text-lg mb-3">Children&apos;s Privacy</h2>
          <p>
